...
RSpec.describe InvestorsController, :type => :controller do
  ...
  describe "GET index" do
    it "assigns all investors as @investors" do
  ...
  describe "GET show" do
    it "assigns the requested investor as @investor" do
      investor = Investor.create! valid_attributes
      get :show, {:id => investor.to_param}, valid_session
  ...
  describe "GET new" do
    it "assigns a new investor as @investor" do
      ...
      expect(assigns(:investor)).to be_a_new(Investor)
    end
  end
  ...
  describe "GET edit" do
    it "assigns the requested investor as @investor" do
      investor = Investor.create! valid_attributes
      get :edit, {:id => investor.to_param}, valid_session
      expect(assigns(:investor)).to eq(investor)
    end
  end
  ...
  describe "POST create" do
    describe "with valid params" do
      it "creates a new Investor" do
        expect {
          post :create, {:investor => valid_attributes}, valid_session
        }.to change(Investor, :count).by(1)
      end

      it "assigns a newly created investor as @investor" do
        post :create, {:investor => valid_attributes}, valid_session
        expect(assigns(:investor)).to be_a(Investor)
        expect(assigns(:investor)).to be_persisted
      end
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved investor as @investor" do
        post :create, {:investor => invalid_attributes}, valid_session
        expect(assigns(:investor)).to be_a_new(Investor)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      ...
      it "updates the requested investor" do
        investor = Investor.create! valid_attributes
        put :update, {:id => investor.to_param, :investor => new_attributes}, valid_session
        investor.reload
      ...
      it "assigns the requested investor as @investor" do
        investor = Investor.create! valid_attributes
        put :update, {:id => investor.to_param, :investor => valid_attributes}, valid_session
        expect(assigns(:investor)).to eq(investor)
      end
    ...
    describe "with invalid params" do
      it "assigns the investor as @investor" do
        investor = Investor.create! valid_attributes
        put :update, {:id => investor.to_param, :investor => invalid_attributes}, valid_session
        expect(assigns(:investor)).to eq(investor)
      end
  ...
  describe "DELETE destroy" do
    it "destroys the requested investor" do
      investor = Investor.create! valid_attributes
      expect {
        delete :destroy, {:id => investor.to_param}, valid_session
      }.to change(Investor, :count).by(-1)
    end
